 ...
 {  
      ...
      $sql = "SELECT eeestudent.id, eeestudent.dept, eeestudent.name, eeestudent.dad, eeestudent.dob, eeestudent.gender, eeestudent.mob, eeestudent.address, eeestudent.aadhar, eeestudent.remarks FROM eeestudent";	  
      $result = mysqli_query($connect, $sql);
      	echo "<table border='1'>
<tr>
<th>ID</th>
