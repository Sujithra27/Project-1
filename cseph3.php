...
<?php   
 ...
 {  
      ...
      $sql = "SELECT csestudent.id, csestudent.dept, csestudent.name, csestudent.dad, csestudent.dob, csestudent.gender, csestudent.mob, csestudent.address, csestudent.aadhar, csestudent.remarks FROM csestudent";	  
      $result = mysqli_query($connect, $sql);
      	echo "<table border='1'>
<tr>
<th>ID</th>
