 ...
 {  
      ...
      $sql = "SELECT ecestudent.id, ecestudent.dept, ecestudent.name, ecestudent.dad, ecestudent.dob, ecestudent.gender, ecestudent.mob, ecestudent.address, ecestudent.aadhar, ecestudent.remarks FROM ecestudent";	  
      $result = mysqli_query($connect, $sql);
      	echo "<table border='1'>
<tr>
<th>ID</th>
