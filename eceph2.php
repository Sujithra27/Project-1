 ...
 {  
      ...
      $sql = "SELECT ecestaff.id, ecestaff.dept, ecestaff.name, ecestaff.dad, ecestaff.dob, ecestaff.gender, ecestaff.mob, ecestaff.address, ecestaff.aadhar, ecestaff.remarks FROM ecestaff";	  
      $result = mysqli_query($connect, $sql);
      	echo "<table border='1'>
<tr>
<th>ID</th>
