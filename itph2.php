 ...
 {  
      ...
      $sql = "SELECT itstaff.id, itstaff.dept, itstaff.name, itstaff.dad, itstaff.dob, itstaff.gender, itstaff.mob, itstaff.address, itstaff.aadhar, itstaff.remarks FROM itstaff";	  
      $result = mysqli_query($connect, $sql);
      	echo "<table border='1'>
<tr>
<th>ID</th>
