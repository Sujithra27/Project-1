 ...
 {  
      ...
      $sql = "SELECT itstudent.id, itstudent.dept, itstudent.name, itstudent.dad, itstudent.dob, itstudent.gender, itstudent.mob, itstudent.address, itstudent.aadhar, itstudent.remarks FROM itstudent";	  
      $result = mysqli_query($connect, $sql);
      	echo "<table border='1'>
<tr>
<th>ID</th>
