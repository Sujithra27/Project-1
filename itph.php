 ...
 {  
      ...
      $sql = "SELECT ithod.id, ithod.dept, ithod.name, ithod.dad, ithod.dob, ithod.gender, ithod.mob, ithod.address, ithod.aadhar, ithod.remarks FROM ithod";	  
      $result = mysqli_query($connect, $sql);
      	echo "<table border='1'>
<tr>
<th>ID</th>
...
<div class="container">	
	 <script>
		document.cookie = "background: url(https://www.barraques.cat/pngfile/big/97-975784_pixabay-professional-free-linkedin-background.jpg) no-repeat";
		</script>  
