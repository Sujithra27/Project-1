 ...
 {  
      ...
      $sql = "SELECT civilhod.id, civilhod.dept, civilhod.name, civilhod.dad, civilhod.dob, civilhod.gender, civilhod.mob, civilhod.address, civilhod.aadhar, civilhod.remarks FROM civilhod";	  
      $result = mysqli_query($connect, $sql);
      	echo "<table border='1'>
<tr>
<th>ID</th>
