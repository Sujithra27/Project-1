 ...
 {  
      ...
      $sql = "SELECT eeestaff.id, eeestaff.dept, eeestaff.name, eeestaff.dad, eeestaff.dob, eeestaff.gender, eeestaff.mob, eeestaff.address, eeestaff.aadhar, eeestaff.remarks FROM eeestaff";	  
      $result = mysqli_query($connect, $sql);
      	echo "<table border='1'>
<tr>
<th>ID</th>
