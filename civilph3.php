<?php   
 ...
 {  
      ...
      $sql = "SELECT civilstudent.id, civilstudent.dept, civilstudent.name, civilstudent.dad, civilstudent.dob, civilstudent.gender, civilstudent.mob, civilstudent.address, civilstudent.aadhar, civilstudent.remarks FROM civilstudent";	  
      $result = mysqli_query($connect, $sql);
      	echo "<table border='1'>
<tr>
<th>ID</th>
...
<div class="container">		   
	<center><strong><h1> RECORDS OF STUDENT</h1></strong></center>
