 ...
 {  
      ...
      $sql = "SELECT csestaff.id, csestaff.dept, csestaff.name, csestaff.dad, csestaff.dob, csestaff.gender, csestaff.mob, csestaff.address, csestaff.aadhar, csestaff.remarks FROM csestaff";	  
      $result = mysqli_query($connect, $sql);
      	echo "<table border='1'>
<tr>
<th>ID</th>
